...
<head>
<link
	href="https://fonts.googleapis.com/css?family=PT+Sans|Ubuntu:400,500"
	rel="stylesheet">
<link rel="stylesheet"
			...
			success : function(authObj) {
				...
				Kakao.API.request({
					...
					success : function(res) {
						/*  kout(); */
						location.href = "kakao.do?id=" + res.id + "&user_name="
...
<body>
	...
	<header>
		...
		<div id="hero-section">
			...
			<!-- <div id="heading"></div> -->
			<video id="video-background" src="resources/video/jabchea.mp4"
				autoplay="autoplay" muted="muted" loop="loop"> 당신의 브라우저에서는
				실행되지 않습니다.
			</video>
			<div id="onvideo">
				<div class="box"></div>
					...
					<div class="form-container">
						<form method="post" action="joinuser.do">
							<div class="sign-up">
								...
								<input type="text" id="idChk" name="user_id" placeholder="ID"
									readonly="readonly" /> <input type="password" id="pass"
									name="user_pw" placeholder="Password" /> <input
									type="password" id="passchk" placeholder="Password Check" />
								<div id="pwch">
								...
								<input type="text" id="sendMessageButton" name="user_email"
									placeholder="Email" readonly="readonly" /> <input
									type="hidden" id="user_confirm" name="user_confirm" value="">
						...
						<div class="login hide">
							...
							<input type="text" id="user_id_login" name="user_id"
								placeholder="Id"><i class="fa fa-envelope-o"></i></input> <input
								type="password" id="user_pw_login" name="user_pw"
								placeholder="Password"><i class="fa fa-lock"></i></input>
