...
SELECT * FROM COMPANY;
UPDATE USERBOARD SET USER_GRADE = 'user' WHERE user_id = '1051248209';
UPDATE USERBOARD SET USER_NAME = '이광석' WHERE user_id = '1051248209';
...
UPDATE USERBOARD SET USER_GRADE = 'bob';

INSERT INTO USERBOARD
VALUES('bobuser5','123','스프링','os9397@naver.com',SYSDATE,'user','N','Y','resources/image/logo.png',1);
...
INSERT INTO MYBOARD VALUES(myBoard_seq.nextval, "공지사항입니다", "공지사항","관리자",SYSDATE, 0);
