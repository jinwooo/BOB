...
VALUES(BMIDSEQ.NEXTVAL,'test',SYSDATE,'아침','짜장면','640','ZZAZANG');

INSERT INTO BOBMANAGER
VALUES(BMIDSEQ.NEXTVAL,'test',SYSDATE,'점심','짬뽕','550','ZZAZANG');

INSERT INTO BOBMANAGER
VALUES(BMIDSEQ.NEXTVAL,'test',SYSDATE,'저녁','탕수육','800','ZZAZANG');
