...
import java.io.IOException;
	...
	public class testapi {
	    public static void main(String[] args) throws IOException {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("fVvHlO1X2h4lmI4mDp6o2Pr%2Bfx73zG%2Bo6XXt1LjEPvs4WCmiE4KxohexkMF6%2BAFodIu%2BCVChGgeLFeLcC4J%2FWw%3D%3D", "UTF-8")); /*Service Key*/
